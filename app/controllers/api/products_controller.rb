module Api
  class ProductsController < ApplicationController
    ...
    def product_params
      params.require(:product).permit(:name, :description, :price, :category_id, :product_attribute_category_id, :is_priority, :is_active, :most_popular, :tag_line, :primary_color, :secondary_color, features: [])
    end
